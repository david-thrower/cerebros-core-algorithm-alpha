...
PHASE_I_A_SAMPLES_TO_CREATE = 500
# Samples to use for the main training stage
PHASE_I_B_SAMPLES_TO_CREATE = 600

DATA_SET_NAME = "tiny-stories-50k-run"
ADDITIONAL_METADATA = "final"
...
def main():
    n_trials = N_TRIALS
    sampler = optuna.samplers.TPESampler(multivariate=True, n_startup_trials=7)
