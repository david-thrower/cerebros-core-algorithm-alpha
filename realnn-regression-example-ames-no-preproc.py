...
from cerebros.simplecerebrosrandomsearch.simple_cerebros_random_search\
    import SimpleCerebrosRandomSearch, CerebrosRealNeuronNetwork
import pendulum
import pandas as pd
...
minimum_axon_neurons = 1
maximum_axon_neurons = 5
axon_activation = 'elu'
min_n_dendrites = 3
max_n_dendrites = 7
dendrite_activation = 'elu'


cerebros =\
    CerebrosRealNeuronNetwork(
        unit_type=DenseUnit,
        ...
        minimum_axon_neurons = minimum_axon_neurons,
        maximum_axon_neurons = maximum_axon_neurons,
